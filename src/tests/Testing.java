...
class SV {
	static ControllingCentre cc;
	static RemoteTerminalUnit rt;
}
...
public class Testing {
	...
	public void t8a_server() {
		SV.rt = new RemoteTerminalUnit();
		SV.rt.launch();
	}
	
	@Test
	public void t8b_client() throws IOException {
		SV.cc = new ControllingCentre();
		SV.cc.launch();
	}
	
	@Test
	public void t8c_connect() throws IOException {
		assertFalse(SV.cc == null);
	}
